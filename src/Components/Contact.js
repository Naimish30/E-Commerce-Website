...
function Contact() {
    return (
        <>
            <Headers />
            <div class="font-[sans-serif] max-w-6xl max-lg:max-w-3xl mx-auto p-4">
                <div class="bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded p-8">
                    ...
                    <div class="grid lg:grid-cols-2 items-start gap-12">
                        <form class="space-y-3 text-gray-800">
                            ...
                            <textarea placeholder='Message' rows="6"
                                class="w-full bg-gray-100 rounded px-6 text-sm pt-3 focus:bg-transparent focus:outline-blue-600"></textarea>
                            <button type='button'
                        ...
                        <div class="grid sm:grid-cols-2  gap-12">
                            <div class="flex items-start bg-white">
                                <div class="shadow-[0_0px_2px_0px_rgba(6,81,237,0.3)] rounded px-3 py-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 fill-blue-600" viewBox="0 0 512 512">
                                ...
                                <div class="ml-6">
                                    ...
                                    <p class="text-sm text-gray-500 mt-1"> 123 Main Street, City, Country</p>
                                </div>
                            </div>

                            <div class="flex items-start bg-white">
                                <div class="shadow-[0_0px_2px_0px_rgba(6,81,237,0.3)] rounded px-3 py-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 fill-blue-600" viewBox="0 0 473.806 473.806">
                                ...
                                <div class="ml-6">
                                    ...
                                    <p class="text-sm text-gray-500 mt-1"> +158 996 888</p>
                                </div>
                            </div>

                            <div class="flex items-start bg-white">
                                <div class="shadow-[0_0px_2px_0px_rgba(6,81,237,0.3)] rounded px-3 py-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 fill-blue-600" viewBox="0 0 32 32">
                                ...
                                <div class="ml-6">
                                    ...
                                    <p class="text-sm text-gray-500 mt-1">info@example.com</p>
                                </div>
                            </div>

                            <div class="flex items-start bg-white">
                                <div class="shadow-[0_0px_2px_0px_rgba(6,81,237,0.3)] rounded px-3 py-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 fill-blue-600" viewBox="0 0 100 100">
                                ...
                                <div class="ml-6">
                                    ...
                                    <p class="text-sm text-gray-500 mt-1">+1-548-2588</p>
                                </div>
                            </div>
                        </div>
                    </div>
